    ...
    const plans = [
        {
            ...
            features: [
                "8 hours of 1-on-1 sessions per month",
        ...
        },
        {
            ...
            period: "per month",
            originalPrice: "$59",
            description: "Most popular choice for comprehensive skill development",
            features: [
                "12 hours of 1-on-1 sessions per month",
                "24/7 AI doubt support",
                "Session recordings access",
                "Weekly progress reports",
        ...
        },
        {
            ...
            period: "per month",
            originalPrice: "$59",
            description: "Complete mastery program with maximum value",
            features: [
                "16 hours of 1-on-1 sessions per month",
                "24/7 AI doubt support",
                "Session recordings access",
                "Weekly progress reports",
            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        Flexible pricing options designed to fit your learning journey.
                        All plans include our core features with varying levels of support and resources.
                    </p>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    {plans.map((plan, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 ${plan.popular ? 'border-green-200 ring-4 ring-green-100' : 'border-gray-100'
                                    } overflow-hidden`}
                            >
                                {plan.popular && (
                                ...
                                <div className={`p-8 ${plan.popular ? 'pt-12' : ''}`}>
                                    <div className="text-center mb-8">
                                        ...
                                        <div className="flex items-center justify-center mb-6">
                                            <span className="text-sm text-gray-500 line-through mr-2">{plan.originalPrice}/month</span>
                                    ...
                                    <button
                                        className={`w-full py-4 rounded-xl font-semibold text-lg transition-all duration-200 transform hover:scale-105 ${plan.popular
                ...
                <div className="mt-16 text-center">
                    <div className="bg-gradient-to-r from-blue-50 to-teal-50 rounded-2xl p-8 max-w-4xl mx-auto">
                        ...
                        <p className="text-gray-600 mb-6">Start with our free trial to experience our teaching methodology and find the perfect fit for your learning goals.</p>
