...
const HeroSection: React.FC<HeroSection> = ({ onOpenTrialModal }) => {
    return (
                    ...
                    <div className="text-center lg:text-left">
                        <div className="flex items-center justify-center lg:justify-start mb-6">
                            <div className="flex items-center bg-orange-100 rounded-full px-4 py-2">
                                ...
                                {/* <span className="text-orange-700 text-sm font-medium">Rated #1 Learning Platform</span> */}
                            </div>
                        </div>
                        ...
                        <p className="text-xl text-gray-600 mb-8 max-w-2xl">
                            "From atendence to academics, manage everything in one place with ease".
                        </p>
                        ...
                        <div className="mt-8 flex items-center justify-center lg:justify-start gap-8">
                            <div className="text-center">
                                <div className="text-2xl font-bold text-gray-900">Simplify   !</div>
                                
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-gray-900">Organize    !</div>
                                
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-gray-900">Educate !</div>
